...
public class PoblarBase {
	...
	{		
		...
		ing5.setPlatosemielaborado(semielaborado2);
		ing6.setPlatosemielaborado(semielaborado2);
		ing7.setPlatosemielaborado(semielaborado2);
		ing8.setPlatosemielaborado(semielaborado2);
		...
		ing14.setPlatosemielaborado(semielaborado3);
		ing15.setPlatosemielaborado(semielaborado3);
		ing1.setPlatosemielaborado(semielaborado3);
		...
		ing17.setPlatosemielaborado(semielaborado4);
		...
		SemiElaboradoEntity semielaborado6=new SemiElaboradoEntity("Acompa�amientos","Especial","Papas Fritas",1,fecha,ue3);
		...
		ing9.setPlatosemielaborado(cocacola);
		...
		ing10.setPlatosemielaborado(pepsi);
		...
		ing11.setPlatosemielaborado(pepsimax);
		...
		ing12.setPlatosemielaborado(cocazero);
		...
		ing13.setPlatosemielaborado(spritezero);
	...
	/*	List<Ingrediente> ingredientesselec=SemiElaboradoDAO.getInstance().getIngredientesPorSemis(8);
		...
		List <Ingrediente> ingp1=PlatoDAO.getInstance().getIngredientes(plato1.toNegocio());
		for (Ingrediente i:ingp1)
		{
			System.out.println(i.getMateriaprima().getCantidad()+" "+i.getMateriaprima().getDescripcion());
		}
		List <Ingrediente> ingp2=PlatoDAO.getInstance().getIngredientes(plato2.toNegocio());
